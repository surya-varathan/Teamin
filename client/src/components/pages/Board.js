...
const Board = ({ match }) => {
  ...
  useEffect(() => {
    if (board?.title) document.title = board.title + ' | Teamin\'';
  }, [board?.title]);
    ...
    <div
      ...
      style={{
        backgroundImage:
          ...
          (board.backgroundURL
            ? board.backgroundURL
            : 'https://images.unsplash.com/photo-1504805572947-34fad45aed93?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto') +
          ')',
      }}
    >
      <Navbar />
